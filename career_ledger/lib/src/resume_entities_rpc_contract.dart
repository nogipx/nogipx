...
@RpcService(
  ...
  description: 'Typed CRUD for resume entities (profiles, experience, projects, etc.)',
)
abstract class IResumeEntitiesContract {
  ...
  Future<Profile> patchProfile(PatchProfileRequest request, {RpcContext? context});

  @RpcMethod(name: 'deleteProfile', kind: RpcMethodKind.unary)
  Future<DeleteRecordResponse> deleteProfile(DeleteEntityRequest request, {RpcContext? context});

  @RpcMethod(name: 'createExperience', kind: RpcMethodKind.unary)
  Future<Experience> createExperience(Experience request, {RpcContext? context});

  @RpcMethod(name: 'updateExperience', kind: RpcMethodKind.unary)
  Future<Experience> updateExperience(Experience request, {RpcContext? context});

  @RpcMethod(name: 'patchExperience', kind: RpcMethodKind.unary)
  Future<Experience> patchExperience(PatchExperienceRequest request, {RpcContext? context});

  @RpcMethod(name: 'deleteExperience', kind: RpcMethodKind.unary)
  Future<DeleteRecordResponse> deleteExperience(DeleteEntityRequest request, {RpcContext? context});
  ...
  Future<Project> patchProject(PatchProjectRequest request, {RpcContext? context});

  @RpcMethod(name: 'deleteProject', kind: RpcMethodKind.unary)
  Future<DeleteRecordResponse> deleteProject(DeleteEntityRequest request, {RpcContext? context});
  ...
  Future<DeleteRecordResponse> deleteSkill(DeleteEntityRequest request, {RpcContext? context});
  ...
  Future<Education> patchEducation(PatchEducationRequest request, {RpcContext? context});

  @RpcMethod(name: 'deleteEducation', kind: RpcMethodKind.unary)
  Future<DeleteRecordResponse> deleteEducation(DeleteEntityRequest request, {RpcContext? context});
  ...
  Future<DeleteRecordResponse> deleteBullet(DeleteEntityRequest request, {RpcContext? context});

  @RpcMethod(name: 'createMediaAsset', kind: RpcMethodKind.unary)
  Future<MediaAsset> createMediaAsset(MediaAsset request, {RpcContext? context});

  @RpcMethod(name: 'updateMediaAsset', kind: RpcMethodKind.unary)
  Future<MediaAsset> updateMediaAsset(MediaAsset request, {RpcContext? context});

  @RpcMethod(name: 'patchMediaAsset', kind: RpcMethodKind.unary)
  Future<MediaAsset> patchMediaAsset(PatchMediaAssetRequest request, {RpcContext? context});

  @RpcMethod(name: 'deleteMediaAsset', kind: RpcMethodKind.unary)
  Future<DeleteRecordResponse> deleteMediaAsset(DeleteEntityRequest request, {RpcContext? context});

  @RpcMethod(name: 'createVariant', kind: RpcMethodKind.unary)
  Future<ResumeVariant> createVariant(ResumeVariant request, {RpcContext? context});

  @RpcMethod(name: 'updateVariant', kind: RpcMethodKind.unary)
  Future<ResumeVariant> updateVariant(ResumeVariant request, {RpcContext? context});

  @RpcMethod(name: 'patchVariant', kind: RpcMethodKind.unary)
  Future<ResumeVariant> patchVariant(PatchVariantRequest request, {RpcContext? context});

  @RpcMethod(name: 'deleteVariant', kind: RpcMethodKind.unary)
  Future<DeleteRecordResponse> deleteVariant(DeleteEntityRequest request, {RpcContext? context});
}

class PatchProfileRequest implements IRpcSerializable {
  PatchProfileRequest({required this.id, required this.expectedVersion, required this.patch});
  final String id;
  final int expectedVersion;
  final RecordPatch patch;

  factory PatchProfileRequest.fromJson(Map<String, dynamic> json) => PatchProfileRequest(
        id: json['id'] as String? ?? '',
        expectedVersion: json['expectedVersion'] as int? ?? 0,
        patch: RecordPatch.fromJson(Map<String, dynamic>.from(json['patch'] as Map? ?? const {})),
      );
...
class PatchExperienceRequest implements IRpcSerializable {
  PatchExperienceRequest({required this.id, required this.expectedVersion, required this.patch});
  final String id;
  final int expectedVersion;
  final RecordPatch patch;

  factory PatchExperienceRequest.fromJson(Map<String, dynamic> json) => PatchExperienceRequest(
        id: json['id'] as String? ?? '',
        expectedVersion: json['expectedVersion'] as int? ?? 0,
        patch: RecordPatch.fromJson(Map<String, dynamic>.from(json['patch'] as Map? ?? const {})),
      );
...
class PatchProjectRequest implements IRpcSerializable {
  PatchProjectRequest({required this.id, required this.expectedVersion, required this.patch});
  final String id;
  final int expectedVersion;
  final RecordPatch patch;

  factory PatchProjectRequest.fromJson(Map<String, dynamic> json) => PatchProjectRequest(
        id: json['id'] as String? ?? '',
        expectedVersion: json['expectedVersion'] as int? ?? 0,
        patch: RecordPatch.fromJson(Map<String, dynamic>.from(json['patch'] as Map? ?? const {})),
      );
...
class PatchSkillRequest implements IRpcSerializable {
  PatchSkillRequest({required this.id, required this.expectedVersion, required this.patch});
  final String id;
  final int expectedVersion;
  final RecordPatch patch;

  factory PatchSkillRequest.fromJson(Map<String, dynamic> json) => PatchSkillRequest(
        id: json['id'] as String? ?? '',
        expectedVersion: json['expectedVersion'] as int? ?? 0,
        patch: RecordPatch.fromJson(Map<String, dynamic>.from(json['patch'] as Map? ?? const {})),
      );
...
class PatchEducationRequest implements IRpcSerializable {
  PatchEducationRequest({required this.id, required this.expectedVersion, required this.patch});
  final String id;
  final int expectedVersion;
  final RecordPatch patch;

  factory PatchEducationRequest.fromJson(Map<String, dynamic> json) => PatchEducationRequest(
        id: json['id'] as String? ?? '',
        expectedVersion: json['expectedVersion'] as int? ?? 0,
        patch: RecordPatch.fromJson(Map<String, dynamic>.from(json['patch'] as Map? ?? const {})),
      );
...
class PatchBulletRequest implements IRpcSerializable {
  PatchBulletRequest({required this.id, required this.expectedVersion, required this.patch});
  final String id;
  final int expectedVersion;
  final RecordPatch patch;

  factory PatchBulletRequest.fromJson(Map<String, dynamic> json) => PatchBulletRequest(
        id: json['id'] as String? ?? '',
        expectedVersion: json['expectedVersion'] as int? ?? 0,
        patch: RecordPatch.fromJson(Map<String, dynamic>.from(json['patch'] as Map? ?? const {})),
      );
...
class PatchMediaAssetRequest implements IRpcSerializable {
  PatchMediaAssetRequest({required this.id, required this.expectedVersion, required this.patch});
  final String id;
  final int expectedVersion;
  final RecordPatch patch;

  factory PatchMediaAssetRequest.fromJson(Map<String, dynamic> json) => PatchMediaAssetRequest(
        id: json['id'] as String? ?? '',
        expectedVersion: json['expectedVersion'] as int? ?? 0,
        patch: RecordPatch.fromJson(Map<String, dynamic>.from(json['patch'] as Map? ?? const {})),
      );
...
class PatchVariantRequest implements IRpcSerializable {
  PatchVariantRequest({required this.id, required this.expectedVersion, required this.patch});
  final String id;
  final int expectedVersion;
  final RecordPatch patch;

  factory PatchVariantRequest.fromJson(Map<String, dynamic> json) => PatchVariantRequest(
        id: json['id'] as String? ?? '',
        expectedVersion: json['expectedVersion'] as int? ?? 0,
        patch: RecordPatch.fromJson(Map<String, dynamic>.from(json['patch'] as Map? ?? const {})),
      );
...
class DeleteEntityRequest implements IRpcSerializable {
  ...
  factory DeleteEntityRequest.fromJson(Map<String, dynamic> json) => DeleteEntityRequest(
        id: json['id'] as String? ?? '',
